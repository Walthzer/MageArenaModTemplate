...
powershell -Command "(gc 'packageFiles\manifest.json') -replace 'MOD_NAME', '%MOD_NAME%' -replace 'AUTHOR_NAME', '%AUTHOR_NAME%' | Out-File -encoding ASCII 'packageFiles\manifest.json'"
